DROP PROCEDURE IF EXISTS `sp_update_device_registering_job`;

DELIMITER //
CREATE PROCEDURE `sp_update_device_registering_job`(OUT sp_result int, IN sp_id int, IN sp_state varchar(45), IN sp_user varchar(45))
BEGIN
    -- ------------------------------------------------------------
    -- ------------------------------------------------------------
