DROP PROCEDURE IF EXISTS `sp_insert_device_profiles`;

DELIMITER //
CREATE PROCEDURE `sp_insert_device_profiles`(OUT sp_result int, IN sp_profile_name varchar(45), IN sp_description text, IN sp_state int, IN sp_user varchar(45))
BEGIN
    -- ------------------------------------------------------------
    -- ------------------------------------------------------------
