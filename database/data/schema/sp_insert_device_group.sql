DROP PROCEDURE IF EXISTS `sp_insert_device_group`;

DELIMITER //
CREATE PROCEDURE `sp_insert_device_group`(OUT sp_result int, IN sp_group_name varchar(45), IN sp_description text, IN sp_state int, sp_user varchar(45))
BEGIN
    -- ------------------------------------------------------------
    -- ------------------------------------------------------------
